"""All tool declarations for Jarvis — one entry per tool Gemini can call."""
...
TOOL_DECLARATIONS = [
    ...
    },
    {
        "name": "search_memory",
        "description": (
            "Search your long-term memory semantically. Call this when the user asks "
            "'do you remember...', 'what do you know about...', 'have I ever told you about...', "
            "or similar recall questions. Returns the most relevant stored facts and past context."
        ),
        "parameters": {
            "type": "OBJECT",
            "properties": {
                "query": {
                    "type": "STRING",
                    "description": "Natural language search query, e.g. 'Priya sister London trip'"
                },
                "top_k": {
                    "type": "INTEGER",
    ...
    },
    {
        "name": "search_files",
        "description": (
            "Search the user's local files semantically. Call this when the user asks about "
            "a document, file, note, code file, PDF, resume, assignment, or anything that "
            "might be stored on their PC. Examples: 'what was in my resume', 'find my ML notes', "
            "'search my documents for X', 'what did I write about Y'. "
            "Returns the most relevant file excerpts."
        ),
        "parameters": {
            "type": "OBJECT",
            "properties": {
                "query": {
                    "type": "STRING",
                    "description": "What to search for, e.g. 'machine learning notes' or 'resume skills'"
                },
                "top_k": {
                    "type": "INTEGER",
                    "description": "Number of files to return (default: 4, max: 8)"
                },
            },
            "required": ["query"]
        }
    ...
    },
    {
        ...
        "description": (
            ...
            "not what they said, but HOW they sounded: pace, energy, flatness, hesitation, warmth. "
            "Call this once per conversation turn whenever you detect a clear non-neutral emotional tone. "
            "Do NOT call for neutral or unclear speech. Do NOT announce you are calling this. "
            "Examples of when to call: user sounds exhausted and slow → tired; "
            "user speaks fast and tense → stressed; user sounds flat and monotone → sad; "
            "user sounds bright and quick → happy; user sounds sharp and clipped → frustrated."
        ),
        "parameters": {
            "type": "OBJECT",
            "properties": {
                "mood": {
                    "type": "STRING",
                    "description": "One of: happy | stressed | tired | sad | frustrated | bored"
                },
                "confidence": {
                    "type": "STRING",
                    "description": "How certain: high | medium | low"
                },
            },
            "required": ["mood"]
        }
